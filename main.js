...
void main() {
  ...
  vec3 smoothedVelocity = mix(selfVelocity, velocity, 0.2); 
...
function generateHeight(width, height) {
  ...
  function getMountainWeight(u, v) {
    ...
    return Math.min(weight, 1.0); // Up to 1
  }
